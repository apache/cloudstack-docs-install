# -*- coding: utf-8 -*-
#
# CloudStack Installation Documentation documentation build configuration file, created by
...
project = u'CloudStack Installation Documentation'
...
htmlhelp_basename = 'CloudStackInstallationDocumentationdoc'
